...
\title{Compte-Rendu TP C++ \#2}
\author{Binôme B3408 \\ {\sc Renault} Benoit, {\sc Espeute} Clément}
\date{}
...
\pagestyle{fancy}
\maketitle
\section[Spécifications]{Spécifications de la classe <Sensor>}

\subsection{Présentation générale}

\subsection{Présentation des structures}
